...
/**
    ...
    @param {String} mimeType as from an HTTP Content-Type
    header.
    @param {Array} parsedRanges as from an HTTP Accept
    header and processed with `parseMediaRange`.
*/
...
/**
    ...
    @param {String} mimeType as from an HTTP Content-Type
    header
    @param {String} ranges as from an HTTP Accept header
*/
...
/**
    ...
    @param {Array * String} MIME types
    @param {String} an HTTP Accept header
*/
