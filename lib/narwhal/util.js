...
/**
 * @param value
 * @returns {Boolean} whether the value is null or
 * undefined
 */
...
/**
 * @param {{toObject} || {length} * [key, value] || Object}
 * object an object of various types that may be converted
 * to a record object.  Objects with `toObject` methods are
 * coerced using that method.  "lengthable" objects are
 * converted to key, value pairs with `items` and converted
 * to objects with the corresponding properties.  Other
 * objects are shallowly copied on their owned properties.
 * @returns {Object}
 */
...
/***
 * @param object
 * @returns a shallow copy on all owned properties
 */
...
/***
 * @param object
 * @returns a deep copy on all owned properties
 */
...
/**
    ...
    @param {Number} a minimum length of the resultant `String`:
    by default, 2
    @param {String} a pad string: by default, `'0'`.
    @returns {String} the value padded up to at least
...
/**
    @param {String || Number} value
    @param {Number} length a minimum length of the resultant
    `String`, by default, 2
    @param {String} pad by default, `'0'`.
    @returns {String} the value padded up to at least
